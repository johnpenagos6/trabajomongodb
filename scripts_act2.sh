...
db.equipos.update({_id:ObjectId("equip2")}, {$set:{"Ciudad":"Los angeles"}})

db.equipos.deleteOne({"_id": ObjectId("equip2")})
...
db.deportistas.update({"_id": ObjectId("dep10003")}, {$set: {"Nombre": "Esteban Marley"}})

db.deportistas.deleteOne({"_id": ObjectId("dep10003")})
...
db.encuentros.update({"_id": ObjectId("encu0001")},{
                       $set: {
                                "Estado": "Jugado",
...
db.encuentros.deleteOne({"_id": ObjectId("encu0001")})
